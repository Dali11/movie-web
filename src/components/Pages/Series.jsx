...
function Series() {
  ...
  const fetchSeries = async () => {
    const { data } = await axios.get(`https://api.themoviedb.org/3/discover/tv?api_key=a0856e0bcc44c755d6e347cdca4cdd92&language=en-US&sort_by=popularity.desc&include_adult=false&include_video=false&page=${page}&with_watch_monetization_types=flatrate`)
  ...
  return (
    <div className='pb-32'>
      <h1 className='flex justify-center text-xl font-bold uppercase pb-6'>tv series</h1>
